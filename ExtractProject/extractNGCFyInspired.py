...
with open('outputNGCFInspired/user_list.txt', 'w') as user_file:
...
with open('outputNGCFInspired/item_list.txt', 'w') as movie_file:
...
with open('outputNGCFInspired/train.txt', 'w') as file:
...
# Write the positive interactions to the text file
with open('outputNGCFInspired/test.txt', 'w') as file:
...
with open('outputNGCFInspired/train_negative.txt', 'w') as file:
