...
class UserItemGraph(nn.Module):
    ...
    def get_user_interaction_item_rep(self, batch):
        ...
        initiator_interaction_item_rep= self._get_user_interaction_item_rep(all_context_items_list)  # (bs, ns_item * user_dim)
        ...
        return initiator_interaction_item_rep , initiator_interaction_item_rep,initiator_interaction_item_rep  # (bs, ns_item * user_dim * 2), (bs, ns_item * user_dim), (bs, ns_item * user_dim)
    ...
    def get_user_interaction_item_rep_recommendation(self, batch):
        ...
        initiator_interaction_item_rep= self._get_user_interaction_item_rep(context_items)  # (bs, ns_item * user_dim)
    ...
    def _get_user_interaction_item_rep(self, context_items):
        ...
        user_interaction_item_rep = self._encode_item_user_profile(context_items, interaction_embeddings)  # (bs, ns_item * user_dim)
        return user_interaction_item_rep
    

    def _get_user_interaction_user_item_profile(self, context_items):
        interaction_embeddings = self.interaction_encoder(None, self.edge_idx, self.edge_type)
        user_interaction_item_user_profile = self._encode_item_user_profile(context_items, interaction_embeddings)  # (bs, dim)
