...
class MultiHeadAttention(nn.Module):
    ...
    def forward(self, query, key=None, value=None, mask=None):
        ...
        attn_mask = (
            (mask == 0)
                .view(batch_size, 1, -1, key_len)  #  [B, 1, 1, key_len] 
                .repeat(1, n_heads, 1, 1)  # [B, n_heads, 1, key_len]
                .expand(batch_size, n_heads, query_len, key_len) #  [B, 1, query_len, key_len]
                .view(batch_size * n_heads, query_len, key_len) # [B * n_heads, query_len, key_len]
        )
...
class TransformerEncoder(nn.Module):
    ...
    def __init__(
        ...
        if not learn_positional_embeddings:
            ...
            nn.init.constant_(self.position_embeddings.weight, 0)  
