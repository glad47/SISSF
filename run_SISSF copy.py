...
from data.data_processing_v1 import DatasetSISSF
    ...
    def initModel(self):
        if self.cli_args.mode == 'semantic':
            ...
            self.model = RecommenderModule(self.cli_args.user_emb_dim,self.cli_args.interaction_emb_dim, self.cli_args.social_emb_dim,
                                           self.cli_args.kg_emb_dim, self.dataset.n_entity,self.cli_args.n_heads,self.cli_args.ffn_size,
                                           self.cli_args.dropout, self.cli_args.attention_dropout, self.dataset.movie_ids, self.device )  
